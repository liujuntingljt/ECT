...
import com.hbsd.rjxy.ect.presenter.IPhoneLoginPresenter;
import com.hbsd.rjxy.ect.presenter.PhoneLoginPresenterCompl;
import com.hbsd.rjxy.ect.util.Constant;
import com.hbsd.rjxy.ect.util.EditTextUtils;
...
public class PhoneLoginActivity extends AppCompatActivity implements IPhoneLoginView {
    ...
    private static final String APP_ID = "1110450575";//QQ官方获取的APPID
                ...
                mUserInfo.getUserInfo(new IUiListener() {
                    ...
                    public void onComplete(Object response) {
                        ...
                        try {
                            ...
                            qqInfor.put("qqOpenid",openID);
                            qqInfor.put("userName",username);
                            qqInfor.put("userHeadPath",userHeadPath);
                            qqInfor.put("gender",gender);
                            iPhoneLoginPresenter.doQQLogin(qqInfor);
                            editor.putString("qqOpenid", openID);
                            editor.putString(Constant.LOGIN_USERNAME,username);
                            editor.putString(Constant.LOGIN_HEADPATH,userHeadPath);
                            editor.putString("gender",gender);
                            Log.e("QQ用户登录的信息",openID+username+userHeadPath+gender);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        editor.commit();
